...
define(["require", "exports", '../ts_library/ts_lib', './ts_item_images', './ts_item_details', './ts_item_cats', './ts_item_partners'], function (require, exports, lib, Img, Dets, Cats, Parts) {
    var AdminView = (function (_super) {
        ...
        AdminView.prototype.onRender = function () {
            var _this = this;
        ...
        AdminView.prototype.load_menus = function () {
        };
        AdminView.prototype.load_view = function () {
    ...
    var AdminExplorer = (function (_super) {
        ...
        function AdminExplorer(options) {
            _super.call(this, options);
        }
        AdminExplorer.prototype.getServiceName = function () {
            return 'item-srv';
        };
        AdminExplorer.prototype.getResourceName = function () {
            return 'item';
        };
        AdminExplorer.prototype.internal_fetch = function () {
            return Q.resolve(true);
        };
        AdminExplorer.prototype.get_dataTable = function (options) {
            //this.datasource.fetch_localDB().then(data => {
            //    var d = data;
            //});
        ...
        AdminExplorer.prototype.get_entry = function (options) {
...
//# sourceMappingURL=C:/umarket/umarket.web.ui/js/ts_admin/ts_admin.js.map